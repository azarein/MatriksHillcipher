...
public class deskripsi {
    private static String privateKey = matrik.keyPair;
    static final Integer encryptKeyPair[][] = matrik.decryptKeyPair;

    public static String getAlphabet(Integer num) {
        return getPrivateKey().split("")[num - 1];
    }
    ...
    public static String decrypt(String source) {
        ...
        if(fileToNum.size() % 2 == 1) {
            fileToNum.add(getPrivateKey().length() - 1);
        }
