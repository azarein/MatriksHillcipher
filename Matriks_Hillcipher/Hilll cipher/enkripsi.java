...
public class enkripsi {
    static final String privateKey = matrik.keyPair;
    static final String zeroKeyCode = matrik.zeroKeyCode;
    static final String randomKey[] = matrik.randomKey;
    static final Integer encryptKeyPair[][] = matrik.encryptKeyPair;
